                ...
                <tr>
                    ...
                    <?php
                     ...
                     ?>
                        ...
                        <td>                                                
                            <input class="form-control" type="tel" name="units" placeholder="ENTER UNITS TO SHARE">
                        </td>
                        <td>
                            <?php echo $row['bdate'] ?> 
                        </td>
                        ...
                        <td>
                            <button type="submit" name="generate_bill" class="btn btn-success form-control">SHARE TOKEN  </button>
                        </td>
                    <?php 
                        } 
                    ?>
